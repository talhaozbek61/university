        ...
        <div
            ...
            <div>
                <div class="text-base leading-7 text-gray-700 lg:max-w-lg">
                    ...
                    <div class="max-w-xl">
                        <p class="mt-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt necessitatibus
                            beatae molestiae assumenda dolore ipsam voluptate inventore officiis mollitia laudantium,
                            sunt tempore quisquam veritatis alias a magnam esse! Quo, odio.</p>
                        <p class="mt-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores magnam,
                            consectetur eum nostrum voluptates dolorum illo deserunt amet. Quod rerum quos laborum quas
                            illum quo eum voluptatibus veniam optio iusto!</p>
                        <p class="mt-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia, quisquam
                            similique iure quis quibusdam molestiae sequi repudiandae consequuntur possimus perspiciatis
                            cumque pariatur necessitatibus reprehenderit magnam ut eveniet minima harum deleniti.</p>
                    </div>
                </div>
                <ul class="mt-10 grid sm:grid-cols-2 gap-10 border-t items-center border-gray-900/10 pt-10">
                    <li>
                        <a href="tel:+901111111111"
