                ...
                <div class="text-base leading-7 text-gray-700 lg:max-w-lg">
                    <div class="flex items-center justify-between">
                        ...
                        <a href=editAbout.php
                            class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Edit
                            Page</a>
                    </div>
