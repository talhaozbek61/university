        ...
        while($row = mysqli_fetch_array($foods)) {
            ...
            echo "
                <div>
                    ...
                    <a href='editProducts.php?id=$id&categories=foods' class='mt-4 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'>Edit</a>
                </div>";
        }
        ?>
    </div>
