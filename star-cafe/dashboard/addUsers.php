<?php
    ...
    if(!$_SESSION)
        ...
        include("utils/add-users-control.php");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <form class="mx-auto max-w-2xl px-6 py-12" action="#" method="GET">
        <div class="space-y-6">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    <label for="email" class="block text-sm font-medium leading-6 text-gray-900">User Email</label>
                    <div class="mt-2">
                ...
                <div class="sm:col-span-6">
                    <label for="password" class="block text-sm font-medium leading-6 text-gray-900">User Password
                    </label>
                    <div class="mt-2">
